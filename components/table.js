                ...
                <table className="table-auto border-collapse w-full">
                    <thead>
                        <tr className="rounded-lg text-sm font-medium text-gray-700 text-left font-size: 0.9674rem">
                            <th className="px-4 py-2 bg-gray-200 background-color:#f8f8f8">Title</th>
                            <th className="px-4 py-2 background-color:#f8f8f8">Author</th>
                            <th className="px-4 py-2 background-color:#f8f8f8">Views</th>
                        </tr>
                    </thead>
